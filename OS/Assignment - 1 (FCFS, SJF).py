...
#     print("Process\t\tArrival Time\tBurst Time\tCompletion Time\t\tTotal Time\tWaiting Time\tResponse Time")
#     for i in range(n):
#         print(f"{processes[i][0]}\t\t{processes[i][1]}\t\t{processes[i][2]}\t\t{turnaround_time[i]}\t\t\t{turnaround_time[i] - processes[i][1]}\t\t{waiting_time[i]}\t\t{waiting_time[i] - processes[i][1]}")
